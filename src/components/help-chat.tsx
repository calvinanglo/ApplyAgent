...
const KNOWLEDGE: Array<{ keywords: string[]; answer: string; links?: Array<{ label: string; href: string }> }> = [
  ...
  { keywords: ['target role', 'roles', 'add role'],
    answer: 'Target roles filter scanner results to only show matching jobs:\n\n1. On the Scanner page, type a role in the Target Roles section\n2. Click Add or press Enter\n3. Click X on any role to remove it\n\nLeaving target roles empty includes all jobs. Examples: "Security Analyst", "Network Engineer", "Cloud Administrator"' },
  ...
  { keywords: ['document', 'documents page', 'resume and cover letter'],
    answer: 'Resume and Cover Letter are unified under one Documents page with tabs:\n\n- Resume tab (3 credits): ATS-optimized 1-page PDF with keyword injection\n- Cover Letter tab (3 credits): Professional letter with header, body, and signature\n\nBoth share the same job selector. Generation history is saved for re-downloading.',
    links: [{ label: 'Go to Documents', href: '/resume' }] },
  // Scanner
  { keywords: ['scan', 'scanner', 'find jobs', 'search jobs', 'companies', 'job search'],
    answer: 'The Scanner finds new jobs matching your profile:\n\n1. Go to Scanner\n2. Toggle companies on/off (110+ pre-loaded across tech, finance, healthcare, retail, and more)\n3. Set filters: keywords, location, job type, work arrangement, date posted\n4. Click Scan (3 credits)\n5. New matches go to your Pipeline\n\nSupports 5 ATS platforms: Greenhouse, Lever, Ashby, SmartRecruiters, and Workday.',
  ...
  { keywords: ['filter', 'remote', 'hybrid', 'on-site', 'full-time', 'part-time', 'contract', 'date posted', 'location filter'],
    answer: 'Scanner filters (in the Filters section):\n\n- Keywords: search terms for job board search\n- Location: used for both board search and career page filtering\n- Job Type: Full-time, Part-time, Contract, Temporary, Permanent, Fixed Term\n- Work Arrangement: Remote, Hybrid, On-site\n- Date Posted: Last 24h, 3 days, 7 days, 14 days\n- Minimum Salary\n\nFilters pre-fill from your Profile on first use, then scanner overrides are saved separately.' },
