...

{
  ...
  "linkedin_url": "(full LinkedIn URL from the CV, e.g. https://www.linkedin.com/in/calvin-anglo, or empty string)",
  "linkedin_display": "(SHORTENED version of linkedin_url with the ACTUAL handle substituted in. Format: 'linkedin.com/in/<actual-handle>'. Example: linkedin_url='https://www.linkedin.com/in/calvin-anglo' -> linkedin_display='linkedin.com/in/calvin-anglo'. NEVER output the literal placeholder words 'name', 'username', or '<handle>' — always substitute the real handle from the URL. Empty string only if linkedin_url is empty.)",
  "github_url": "(full GitHub URL from the CV, e.g. https://github.com/calvinanglo. NOT .github.io sites. Empty string if absent.)",
  "github_display": "(SHORTENED version of github_url with the ACTUAL handle substituted in. Format: 'github.com/<actual-handle>'. Example: github_url='https://github.com/calvinanglo' -> github_display='github.com/calvinanglo'. NEVER output the literal placeholder words 'username' or 'user' — always substitute the real handle from the URL. Empty string only if github_url is empty.)",
